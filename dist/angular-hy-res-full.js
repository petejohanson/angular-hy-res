...
angular.module("angular-hy-res-hal", ["angular-hy-res"]).provider("hrHalExtension", function () {
  ...
  this.$get = ["hrWebLinkFactory", "hrLinkCollection", function (hrWebLinkFactory, hrLinkCollection) {
    ...
    var HalExtension = function HalExtension() {
...
angular.module("angular-hy-res-siren", ["angular-hy-res"]).provider("hrSirenExtension", function () {
  ...
  this.$get = ["hrWebLinkFactory", "hrLinkCollection", function (hrWebLinkFactory, hrLinkCollection) {
    ...
    var SirenExtension = function SirenExtension() {
      this.applies = function (data, headers) {
        return mediaTypeSet[headers("Content-Type")] !== undefined;
      };
...
/***/function (module, exports, __webpack_require__) {
  ...
  angular.module("angular-hy-res-link-header", ["angular-hy-res"]).service("hrLinkHeaderExtension", function (hrWebLinkFactory) {
    this.applies = function (data, headers) {
